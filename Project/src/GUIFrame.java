...
public class GUIFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(this.getValues() == 1){
            ProducerConsumer proCon = new ProducerConsumer(this, bufferSize, timeProductores,
                cantProductores, timeConsumidores, cantConsumidores, rangeM, rangeN);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private int getValues(){
        try{
            this.cantProductores = (Integer) this.jSpinner1.getValue();
            this.cantConsumidores = (Integer) this.jSpinner2.getValue();
            this.timeProductores = Integer.parseInt(this.jTextField1.getText());
            this.timeConsumidores = Integer.parseInt(this.jTextField2.getText());
            this.bufferSize = Integer.parseInt(this.jTextField3.getText());
            this.rangeM = Integer.parseInt(this.jTextField4.getText()); 
            this.rangeN = (Integer) this.jSpinner3.getValue();
            
            if(this.cantProductores < 1|| this.cantConsumidores < 1 || 
               this.bufferSize < 1 || this.rangeM < 1 || this.rangeN < 1 ||this.rangeM > this.rangeN){
                System.out.println("Incorrect Input. Values must be integers and > 0");
                return 0;
            }
